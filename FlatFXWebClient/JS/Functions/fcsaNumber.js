...
/* https://github.com/FCSAmerica/angular-fcsa-number/blob/master/src/fcsaNumber.js */
...
(function () {
    ...
    fcsaNumberModule.directive('fcsaNumber', [
      'fcsaNumberConfig', function (fcsaNumberConfig) {
          ...
          addCommasToInteger = function (val, showDecimals) {
              ...
              else if (showDecimals > 0 && decimals.length > 0) {
                  return "" + commas + decimals.toString().substr(0, (showDecimals + 1));
              }
              else
          ...
          return {
              ...
              link: function (scope, elem, attrs, ngModelCtrl) {
                  ...
                  ngModelCtrl.$formatters.push(function (val) {
                      ...
                      ngModelCtrl.$setValidity('fcsaNumber', true);
                      val = addCommasToInteger(val.toString(), options.showDecimals);
